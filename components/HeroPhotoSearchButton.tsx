...
export default function HeroPhotoSearchButton({ onClick, loading = false }: Props) {
  return (
    <button
      ...
      className="w-10 h-10 rounded-none bg-gray-100 hover:bg-gray-200 transition-colors flex items-center justify-center text-gray-700 shrink-0 disabled:opacity-60"
    >
      {loading ? (
