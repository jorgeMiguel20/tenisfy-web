...
export default function CompareNavLink() {
  ...
  return (
    <Link
      href={href}
      aria-label="Comparar"
      className="flex shrink-0 items-center justify-center gap-1.5 min-h-[44px] px-1 text-sm font-medium text-gray-600 hover:text-gray-900 hover:font-semibold transition-colors"
    >
      ...
      {count > 0 && (
        // Mesma cor da marca usada no selo de desconto (ProductCard.tsx) e
